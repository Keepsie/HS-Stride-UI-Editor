    ...
    public class UIElementViewModel : INotifyPropertyChanged
    {
        ...
        public UIElementViewModel Clone(string newName)
        {
            var clone = new UIElementViewModel(newName, ElementType)
            {
                ...
                ShouldSnapToTicks = ShouldSnapToTicks,
                IsDirectionReversed = IsDirectionReversed,
                TrackStartingOffsetLeft = TrackStartingOffsetLeft,
                TrackStartingOffsetTop = TrackStartingOffsetTop,
                TrackStartingOffsetRight = TrackStartingOffsetRight,
                TrackStartingOffsetBottom = TrackStartingOffsetBottom,

                // StackPanel
                StackPanelOrientation = StackPanelOrientation,
                ItemVirtualizationEnabled = ItemVirtualizationEnabled,

                // EditText
                EditTextImageMode = EditTextImageMode,
                EditTextActiveImage = EditTextActiveImage,
                EditTextActiveFrame = EditTextActiveFrame,
                EditTextActiveImageAsset = EditTextActiveImageAsset,
                EditTextInactiveImage = EditTextInactiveImage,
                EditTextInactiveFrame = EditTextInactiveFrame,
                EditTextInactiveImageAsset = EditTextInactiveImageAsset,
                EditTextMouseOverImage = EditTextMouseOverImage,
                EditTextMouseOverFrame = EditTextMouseOverFrame,
                EditTextMouseOverImageAsset = EditTextMouseOverImageAsset,
                CaretColor = CaretColor,
                CaretWidth = CaretWidth,
                SelectionColor = SelectionColor,
                IMESelectionColor = IMESelectionColor,
                MaxLength = MaxLength,
                IsReadOnly = IsReadOnly,
                MinLines = MinLines,
                MaxLines = MaxLines,
                InputType = InputType,
                CaretFrequency = CaretFrequency,

                // ToggleButton
                ToggleImageMode = ToggleImageMode,
                ToggleCheckedImage = ToggleCheckedImage,
                ToggleCheckedFrame = ToggleCheckedFrame,
                ToggleCheckedImageAsset = ToggleCheckedImageAsset,
                ToggleUncheckedImage = ToggleUncheckedImage,
                ToggleUncheckedFrame = ToggleUncheckedFrame,
                ToggleUncheckedImageAsset = ToggleUncheckedImageAsset,
                ToggleIndeterminateImage = ToggleIndeterminateImage,
                ToggleIndeterminateFrame = ToggleIndeterminateFrame,
                ToggleIndeterminateImageAsset = ToggleIndeterminateImageAsset,
                ...
                // ContentDecorator/Border
                ContentDecoratorImageMode = ContentDecoratorImageMode,
